  ...
  <div id="app" style="padding-bottom: 300px">
    ...
    <div>
      <div style="width: 840px; margin: 0 auto; height: 300px">
        <button @click="refreshNode">refreshAsyncNode</button>
      </div>
    </div>
    ...
    <div>
      <div style="width: 840px; margin: 0 auto">
        ...
        <div style="width: 50%; display: inline-block">
          <textarea style="height: 300px; width: 100%" v-model="data"> </textarea>
        </div>
      </div>
    </div>
    ...
    <div>
      <div style="width: 840px; margin: 0 auto">
        ...
        <div style="width: 50%; display: inline-block">
          <textarea style="height: 300px; width: 100%" v-model="data3"> </textarea>
        </div>
      </div>
    </div>
  </div>
